    ...
    <>
      ...
      <ScrollAnimationWrapper>
        <div className="flex flex-col min-h-screen bg-slate-50">
          ...
          {/* Hero Section */}
          <section className="relative py-20 md:py-32 px-6 md:px-12 premium-gradient overflow-hidden text-white flex-grow">
            {/* Background Pattern */}
            ...
            <div className="relative max-w-[1000px] mx-auto flex flex-col items-center text-center gap-8 z-10">
              ...
              <div className="scroll-animation w-full max-w-3xl mt-8">
                <div className="flex flex-col items-center justify-center p-6 bg-emerald-50 border border-emerald-200 rounded-xl text-center animate-in fade-in zoom-in duration-300 text-slate-900">
